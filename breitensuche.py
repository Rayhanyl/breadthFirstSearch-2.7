...
# 2.2.5 (kuerzester Weg)

# Findet einen Pfad zum ziel_knoten, wenn fuer jeden Knoten
# sein Vater-Knoten in einem eltern_dict vorhanden ist.
...
print "Breitensuche in graph_gerichtet: ", breitensuche(graph_gerichtet, 'A')  # A F D G E B H C I
print ""
print "ist_weg_vorhanden in graph_1"
...
print "  von A nach Z: ", kuerzester_weg(graph_2, 'A', 'Z')  #
print ""
